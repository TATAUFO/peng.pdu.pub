...
本文提出了一种新的点对点的社交网络系统。该系统在不需要第三方服务参与。任何具有相同私钥签名且具有全序关系的消息序列都被系统承认为合法的发布者身份。通过消息之间的互动，发布者身份之间能够形成公开的关联关系。任何使用者都可以根据这种关联关系，按自定义规则维护可见的发布者身份范围，并在这个范围内有效的进行信息过滤。
